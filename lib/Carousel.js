  ...
  Carousel = (function(_super) {
    function Carousel(props) {
      ...
      return (
        ...
        (_this.next = utils_1.throttle(
          _this.next.bind(_this),
          props.transitionDuration || defaultTransitionDuration,
          _this.setIsInThrottle
        )),
        (_this.previous = utils_1.throttle(
          _this.previous.bind(_this),
          props.transitionDuration || defaultTransitionDuration,
          _this.setIsInThrottle
        )),
        (_this.goToSlide = utils_1.throttle(
          _this.goToSlide.bind(_this),
          props.transitionDuration || defaultTransitionDuration,
          _this.setIsInThrottle
        )),
        (_this.onMove = !1),
        (_this.initialX = 0),
        (_this.lastX = 0),
        (_this.isAnimationAllowed = !1),
        (_this.direction = ""),
        (_this.initialY = 0),
        (_this.isInThrottle = !1),
        _this
      );
    }
    return (
      ...
      (Carousel.prototype.setIsInThrottle = function(isInThrottle) {
        void 0 === isInThrottle && (isInThrottle = !1),
      ...
      (Carousel.prototype.setClones = function(
        slidesToShow,
        itemWidth,
        forResizing
      ) {
        ...
        var childrenArr = React.Children.toArray(this.props.children),
          initialSlide = utils_1.getInitialSlideInInifteMode(
            slidesToShow || this.state.slidesToShow,
            childrenArr
          ),
          clones = utils_1.getClones(this.state.slidesToShow, childrenArr);
        utils_1.notEnoughChildren(this.state, this.props, slidesToShow) ||
          this.setState(
            {
      ...
      (Carousel.prototype.setContainerAndItemWidth = function(
        slidesToShow,
        ...
        if (this.containerRef && this.containerRef.current) {
          var containerWidth = this.containerRef.current.offsetWidth,
            itemWidth_1 = utils_1.getItemClientSideWidth(
              this.props,
              slidesToShow,
              containerWidth
            );
          this.setState(
            { containerWidth: containerWidth, itemWidth: itemWidth_1 },
            function() {
              _this.props.infinite &&
                _this.setClones(
                  slidesToShow,
                  itemWidth_1,
                  shouldCorrectItemPosition
      ...
      (Carousel.prototype.correctItemsPosition = function(
        itemWidth,
        isAnimationAllowed
      ) {
        isAnimationAllowed && (this.isAnimationAllowed = !0),
          !isAnimationAllowed &&
            this.isAnimationAllowed &&
            (this.isAnimationAllowed = !1),
          this.setState({ transform: -itemWidth * this.state.currentSlide });
      }),
      (Carousel.prototype.onResize = function(value) {
        var shouldCorrectItemPosition;
        (shouldCorrectItemPosition =
          !!this.props.infinite && ("boolean" != typeof value || !value)),
      ...
      (Carousel.prototype.componentDidUpdate = function(_a, _b) {
        ...
        this.containerRef &&
          ...
          autoPlay ||
            ...
            (this.autoPlay = setInterval(this.next, this.props.autoPlaySpeed)),
          this.props.infinite &&
            this.correctClonesPosition({ domLoaded: domLoaded });
      }),
      (Carousel.prototype.correctClonesPosition = function(_a) {
        ...
        this.state.domLoaded &&
          domLoaded &&
          (isReachingTheEnd || isReachingTheStart) &&
          ((this.isAnimationAllowed = !1),
          setTimeout(function() {
            _this.setState({
      ...
      (Carousel.prototype.next = function(slidesHavePassed) {
        ...
        if (!utils_1.notEnoughChildren(this.state, this.props)) {
          var _b = utils_1.populateNextSlides(
              this.state,
              this.props,
              slidesHavePassed
            ),
          ...
          void 0 !== nextSlides &&
            void 0 !== nextPosition &&
            ("function" == typeof beforeChange &&
              beforeChange(nextSlides, this.getState()),
            (this.isAnimationAllowed = !0),
            this.setState(
              { transform: nextPosition, currentSlide: nextSlides },
              function() {
                "function" == typeof afterChange &&
                  setTimeout(function() {
      ...
      (Carousel.prototype.previous = function(slidesHavePassed) {
        ...
        var _a = this.props,
          ...
          beforeChange = _a.beforeChange;
        if (!utils_1.notEnoughChildren(this.state, this.props)) {
          var _b = utils_1.populatePreviousSlides(
              this.state,
              this.props,
              slidesHavePassed
            ),
      ...
      (Carousel.prototype.handleDown = function(e) {
        if (
          !(
            (!types_1.isMouseMoveEvent(e) && !this.props.swipeable) ||
            (types_1.isMouseMoveEvent(e) && !this.props.draggable) ||
            this.isInThrottle
          )
        ) {
      ...
      (Carousel.prototype.handleMove = function(e) {
        if (
          !(
            (!types_1.isMouseMoveEvent(e) && !this.props.swipeable) ||
            (types_1.isMouseMoveEvent(e) && !this.props.draggable) ||
            utils_1.notEnoughChildren(this.state, this.props)
          )
        ) {
          var _a = types_1.isMouseMoveEvent(e) ? e : e.touches[0],
            clientX = _a.clientX,
          ...
          if (
            ...
            var _b = utils_1.populateSlidesOnMouseTouchMove(
                this.state,
                this.props,
                this.initialX,
                this.lastX,
      ...
      (Carousel.prototype.handleOut = function(e) {
        this.props.autoPlay &&
          !this.autoPlay &&
          (this.autoPlay = setInterval(this.next, this.props.autoPlaySpeed));
        var shouldDisableOnMobile =
            "touchend" === e.type && !this.props.swipeable,
        ...
        if (!shouldDisableOnMobile && !shouldDisableOnDesktop && this.onMove) {
          if ("right" === this.direction)
            if (this.initialX - this.lastX >= this.props.minimumTouchDrag) {
              var slidesHavePassed = Math.round(
      ...
      (Carousel.prototype.goToSlide = function(slide) {
        ...
        if (!this.isInThrottle) {
          ...
          "function" == typeof beforeChange &&
            ...
            (this.isAnimationAllowed = !0),
            this.setState(
              { currentSlide: slide, transform: -itemWidth * slide },
              function() {
                _this.props.infinite &&
                  _this.correctClonesPosition({ domLoaded: !0 }),
                  "function" == typeof afterChange &&
                    setTimeout(function() {
                      afterChange(previousSlide, _this.getState());
                    }, _this.props.transitionDuration ||
        ...
        return customButtonGroup
          ? React.cloneElement(customButtonGroup, {
              ...
              goToSlide: function(slideIndex) {
                return _this.goToSlide(slideIndex);
              },
      ...
      (Carousel.prototype.render = function() {
        var _a = this.props,
          ...
          containerClass = (_a.infinite, _a.containerClass),
        ...
        var _b = utils_1.getInitialState(this.state, this.props),
          ...
          shouldShowArrows =
            (utils_1.isInLeftEnd(this.state),
            utils_1.isInRightEnd(this.state),
            arrows &&
              !(
                removeArrowOnDeviceType &&
                ((deviceType &&
                  -1 < removeArrowOnDeviceType.indexOf(deviceType)) ||
                  (this.state.deviceType &&
                    -1 <
                      removeArrowOnDeviceType.indexOf(this.state.deviceType)))
              ) &&
              !utils_1.notEnoughChildren(this.state, this.props) &&
              shouldRenderAtAll),
          currentTransform = partialVisbile
            ? utils_1.getTransformForPartialVsibile(
                this.state,
        ...
        return React.createElement(
          ...
          React.createElement(
            ...
            {
              className:
                "react-multi-carousel-list " + containerClass + " " + className,
